...
if [ ! -d ../annot_utils2/data/hg19 ]
then
    mkdir -p ../annot_utils2/data/hg19
fi

if [ ! -d ../annot_utils2/data/hg38 ]
then
    mkdir -p ../annot_utils2/data/hg38
fi

if [ ! -d ../annot_utils2/data/mm10 ]
then
    mkdir -p ../annot_utils2/data/mm10
fi
...
mv refGene.txt.gz ../annot_utils2/data/hg19
mv wgEncodeGencodeBasicV19.txt.gz ../annot_utils2/data/hg19
# mv wgEncodeGencodeCompV31lift37.txt.gz ../annot_utils2/data/hg19
...
mv refGene.txt.gz ../annot_utils2/data/hg38
# mv wgEncodeGencodeBasicV28.txt.gz ../annot_utils2/data/hg38
mv wgEncodeGencodeCompV31.txt.gz ../annot_utils2/data/hg38
...
mv refGene.txt.gz ../annot_utils2/data/mm10
# mv wgEncodeGencodeBasicVM18.txt.gz ../annot_utils2/data/mm10
mv wgEncodeGencodeCompVM22.txt.gz ../annot_utils2/data/mm10
